...
public class Report implements Feature{
	...
	/**
	 * <br>Adds a data renderer to this report.</br>
	 * <br>Data renderer is a {@link JComponent} supplier.</br>
	 */
	public Report addDataRenderer(Supplier<JComponent>dataRenderer){dataRenderers.add(dataRenderer);return this;}
	/**
	 * <br>Adds a configurator to this report.</br>
	 * <br>The configurator is a {@link Function} which takes a saver as input and returns a {@link JComponent}. The component is added to the top of the tab.</br>
	 */
