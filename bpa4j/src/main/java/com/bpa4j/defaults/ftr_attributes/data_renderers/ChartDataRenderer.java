...
public class ChartDataRenderer implements Supplier<JComponent>{
	 ...
	 * </ul>
	 */
	public ChartDataRenderer(ChartMode mode,Supplier<ArrayList<Object[]>>elementSupplier,Object...args){this.mode=mode;this.elementSupplier=elementSupplier;this.args=args.clone();}
