...
import com.bpa4j.util.codegen.EditableNodeV2.Property;
import com.bpa4j.util.codegen.ProjectGraphV2.NavigatorNode.HelpEntry;
import com.bpa4j.util.codegen.ProjectGraphV2.NavigatorNode.Instruction;
 ...
 */	
	public static class NavigatorNode extends ProjectNode {
		 ...
		 */
		public NavigatorNode(ProjectGraphV2 project) {
	 ...
	 */
	public ProjectGraphV2(File projectFolder) {
					...
					if (file.toString().endsWith(".java")) {
						...
						if (mainClass.isPresent()) {
							...
							if (editableClass.isPresent()) {
								nodes.add(new EditableNodeV2(file.toFile()));
							}
						}
	...
	public EditableNodeV2 createEditableNode(String name, String objectName, EditableNodeV2.Property... properties) {
		...
		EditableNodeV2 n = new EditableNodeV2(file, objectName, properties);
		nodes.add(n);
		return n;
	}
	...
	private void fillObjectsTab(JPanel tab){
		...
		class B extends JPanel{
			public B(Property p,EditableNodeV2 n){
		...
		class E extends JPanel{
			public E(EditableNodeV2 n){
				...
				rename.addActionListener(e->{
					...
					if(!n.name.equals(s[0]))n.changeNameIn(ProjectGraphV2.this,s[0]);
		...
		for(ProjectNode node:nodes)if(node instanceof EditableNodeV2)objList.add(new E((EditableNodeV2)node));
	}
