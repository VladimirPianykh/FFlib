...
public class SwingLogWatchModuleRenderer implements ModuleRenderer<LogWatchModule>{
    public void createTab(Editable editable,boolean isNew,Runnable deleter,LogWatchModule module,ModulesRenderingContext context){
        ...
        class LocalComment extends HButton{
            ...
            public LocalComment(ActionRecord s,int index){
                ...
                this.s=s;
                setAction(new javax.swing.AbstractAction(){
                    public void actionPerformed(java.awt.event.ActionEvent e){
                        java.awt.Toolkit.getDefaultToolkit().getSystemClipboard().setContents(new java.awt.datatransfer.StringSelection(s.text),null);
                    }
                });
            }
                ...
                if(s.text.charAt(0)==':'){
                    ...
                    switch(t){
                        case "CREATED","DELETED":
                            ...
                            Shape sh=g2.getFont().createGlyphVector(g2.getFontRenderContext(),str).getOutline((getWidth()-fm.stringWidth(str))/2,(getHeight()+fm.getAscent()+fm.getLeading()-fm.getDescent())/2);
