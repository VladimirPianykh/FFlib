...
public class ItemListRenderer<T extends Serializable> implements FeatureRenderer<ItemList<T>>{
	private ItemList<T> contract;
	private ItemListModel<T> model;
	private Class<T> type;
	public ItemListRenderer(ItemList<T> contract,ItemListModel<T> model,Class<T> type){
