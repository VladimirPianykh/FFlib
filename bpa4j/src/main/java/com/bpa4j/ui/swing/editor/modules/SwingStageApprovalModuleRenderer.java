...
public class SwingStageApprovalModuleRenderer implements ModuleRenderer<StageApprovalModule>{
	private JPanel createTabPanel(Editable editable,boolean isNew,Runnable deleter,StageApprovalModule module,ModulesRenderingContext context){
		SwingModuleRenderingContext ctx=(SwingModuleRenderingContext)context;
		Processable p=(Processable)editable;
		JPanel tab=SwingFormModuleRenderer.createTabPanel(editable,isNew,deleter,module,context);
