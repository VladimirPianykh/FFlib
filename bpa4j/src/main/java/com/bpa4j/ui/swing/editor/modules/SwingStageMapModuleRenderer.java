...
public class SwingStageMapModuleRenderer implements ModuleRenderer<StageMapModule>{
	public void createTab(Editable editable,boolean isNew,Runnable deleter,StageMapModule editorModule,ModulesRenderingContext context){
